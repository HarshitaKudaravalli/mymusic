...
<%
	...
	String email = request.getParameter("fname");
        String uname = request.getParameter("rt");
        String uname1 = request.getParameter("dob");
        String uname2 = request.getParameter("hd");
	...
	try {
		...
		stmt = conn.createStatement();
                ...
                stmt.executeUpdate("insert into employee values('"+name+"','"+gender+"','"+email+"','"+uname+"','"+uname1+"','"+uname2+"','"+pass+"','"+addr+"','"+pno+"','"+pno1+"','"+pno2+"','"+pno3+"','"+pno4+"','"+pno5+"')");
               
                rs = stmt.executeQuery("select * from employee where EmployeeId='"+name+"'");
